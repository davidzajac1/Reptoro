...
- top (boolean; optional):
    ...
    def __init__(self, children=None, id=Component.UNDEFINED, style=Component.UNDEFINED, className=Component.UNDEFINED, key=Component.UNDEFINED, tag=Component.UNDEFINED, top=Component.UNDEFINED, bottom=Component.UNDEFINED, src=Component.UNDEFINED, alt=Component.UNDEFINED, title=Component.UNDEFINED, loading_state=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'alt', 'bottom', 'className', 'key', 'loading_state', 'src', 'style', 'tag', 'title', 'top']
        self._type = 'CardImg'
        self._namespace = 'dash_bootstrap_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'alt', 'bottom', 'className', 'key', 'loading_state', 'src', 'style', 'tag', 'title', 'top']
