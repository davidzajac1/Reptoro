...
- className (string; optional):
    Defines the className of the carousel container.  This is often
    used with CSS to style elements with common properties.
...
- interval (number | string | boolean; optional):
    ...
    5000) If set to False, carousel will not Autoplay (i.e. will not
    automatically cycle).
...
- style (dict; optional):
    ...
    previously set."""
    @_explicitize_args
    def __init__(self, id=Component.UNDEFINED, style=Component.UNDEFINED, className=Component.UNDEFINED, items=Component.REQUIRED, active_index=Component.UNDEFINED, controls=Component.UNDEFINED, indicators=Component.UNDEFINED, ride=Component.UNDEFINED, slide=Component.UNDEFINED, interval=Component.UNDEFINED, loading_state=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'active_index', 'className', 'controls', 'indicators', 'interval', 'items', 'loading_state', 'ride', 'slide', 'style']
        self._type = 'Carousel'
        self._namespace = 'dash_bootstrap_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'active_index', 'className', 'controls', 'indicators', 'interval', 'items', 'loading_state', 'ride', 'slide', 'style']
